...
import { useWindowDimensions, View,Text, Pressable, ImageBackground,StyleSheet } from 'react-native';
...
<View
  ...
  <View style={{
   ...
   <View style={{width:'70%'}}>
     <Text style={{color:'white'}}>Cargue su perfil, el perfil debe ser claro y debe presentarlo, cualquier violación puede suspender su cuenta</Text>
   </View>
  {
    logo ? 
