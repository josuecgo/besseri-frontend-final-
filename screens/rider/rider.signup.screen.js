...
import {  LOGIN_SIGNUP_FORGOT_ROUTES,
    ROLES,
    SCREEN_HORIZONTAL_MARGIN,
    RIDER_ROUTES,
    showToaster, 
    MAIN_ROUTES} from '../../util/constants';
import { saveUserData } from '../../util/local-storage/auth_service';
...
const TEXT_TO_RENDER = {
  [ROLES.BUSINESS]: {
    textHeading: 'Create Rider account',
    subText: 'Rider Account',
  },
};
    ...
    <CustomSafeAreaViewComponent>
      ...
      <View
        ...
        <View style={{
         ...
         <View style={{width:'70%'}}>
           <Text style={{color:'white'}}>Upload your profile, profile must be clear and should present you, any violation can get your account suspended</Text>
         </View>
        {
          logo ? 
