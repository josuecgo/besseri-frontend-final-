    ...
    return (
        <View style={{ flex: 1, backgroundColor: 'white' }}>
            ...
            <ScrollView
                ...
                <TouchableOpacity onPress={() => props.navigation.navigate(RIDER_STACK_ROUTES.DESCRIPTION, { order })} >
                    <Text
                        style={[
                            CommonStyles.fontFamily,
                            styles.customerHeading,
                            { marginVertical: 10, textDecorationLine: 'underline',marginHorizontal:10, fontSize: adjust(13),color:Colors.primarySolid },
                        ]}>
                        Detalles del pedido
                    </Text>
                </TouchableOpacity>
