...
export const customer_api_urls = {
    ...
    add_recent_product:`${base_url}/products/save-recent-product`,
    get_recent_product:`${base_url}/products/recent-product`,
    ...
    detail_quote:`${base_url}/products/get-detail-quote`,
    quote_recived:`${base_url}/products/quote-customer`,
    create_product_quote:`${base_url}/products/create-product-quote`,
    ...
    response_question:`${base_url}/question/response-question`,
