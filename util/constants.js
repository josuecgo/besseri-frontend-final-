...
export const LOGIN_SIGNUP_FORGOT_ROUTES = {
  ...
  RECOVERY_OTP_PASSWORD: 'RECOVERY_OTP_PASSWORD',
...
export const CUSTOMER_HOME_SCREEN_ROUTES = {
  ...
  ACCOUNT_RECENT_PRODUCTS : 'Articulos recientes',
  ACCOUNT_MY_ADDRESS : 'Mis direcciones',
  ACCOUNT_MY_QUOTE : 'Mis cotizaciones',
  ACCOUNT_DETAIL_QUOTE : 'Cotizacion',
  ACCOUNT_VIEW_MY_ADDRESS : 'Ver mis direcciones',
  ACCOUNT_SEARCH_MY_ADDRESS : 'Search Address',
  ...
  DETAILQUESTIONSCREEN:'DETAILQUESTIONSCREEN',
  ...
  QUOTE_FORM_SCREEN:'QuoteFormScreen',
  PRODUCT_REVIEWS: 'PRODUCT Reviews',
  SERVICE_REVIEWS: 'SERVICE_REVIEWS',
  FORM_PRODUCT_REVIEWS: 'FORM_PRODUCT_REVIEWS',
  FORM_SERVICE_REVIEWS: 'FORM_SERVICE_REVIEWS',
